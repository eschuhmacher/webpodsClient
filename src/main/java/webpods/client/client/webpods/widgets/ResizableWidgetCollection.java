...
import java.lang.Deprecated;import java.lang.Iterable;import java.lang.Override;import java.util.HashMap;
...
public class ResizableWidgetCollection implements WindowResizeListener,
        ...
        for (Map.Entry<ResizableWidget, ResizableWidgetInfo> entry : widgets.entrySet()) {
            ...
            if (info.updateSizes()) {
                ...
                if (info.getOffsetWidth() > 0 && info.getOffsetHeight() > 0
                        && widget.isAttached()) {
                    // Send the webpods.client dimensions, which is the space available for
                    // rendering.
     ...
     *
     * @param width the width of the window's webpods.client area.
     * @param height the height of the window's webpods.client area.
     */
    @Deprecated
