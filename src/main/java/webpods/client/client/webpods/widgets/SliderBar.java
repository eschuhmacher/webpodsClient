...
import java.lang.Double;import java.lang.Math;import java.lang.Override;import java.lang.String;import java.util.ArrayList;
...
public class SliderBar extends FocusPanel implements ResizableWidget,
     ...
     */
    public SliderBar(double minValue, double maxValue, PV pv) {
        this(minValue, maxValue, null, pv);
    }
    ...
    public SliderBar(double minValue, double maxValue,
                     LabelFormatter labelFormatter, PV pv) {
        this(minValue, maxValue, labelFormatter,
                (SliderBarImages) GWT.create(SliderBarImages.class), pv);
    }
     ...
     */
    public SliderBar(double minValue, double maxValue,
                     LabelFormatter labelFormatter, SliderBarImages images, PV pv) {
        super();
    ...
    /*-{
        ...
        pv.addCallback(function(evt, pv) {
            ...
            case "value": //value changed
                ...
                pvValue = evt.value;
                instance.@webpods.client.client.webpods.widgets.SliderBar::update(Lwebpods/client/client/webpods/PvValue;)(pvValue);
                break;
    ...
    private void update(PvValue value) {
        setCurrentValue(Double.valueOf((String) value.getValue()));
    ...
    private void updateStype(Alarm alarm, PvDisplay display) {
        ...
        if(alarm.getSeverity() == "MAJOR") {
            DOM.setElementProperty(lineElement, "className", "gwt-SliderBar-line-error");
        } else if (alarm.getSeverity() == "MINOR"){
            DOM.setElementProperty(lineElement, "className", "gwt-SliderBar-line-warning");
        } else {
            DOM.setElementProperty(lineElement, "className", "gwt-SliderBar-line");
        }
        if(display != null) {
            setMaxValue(display.getHighDisplay());
            setMinValue(display.getLowDisplay());
        }
    }

    private void updatePV() {
        pv.setValue(String.valueOf(getCurrentValue()));
    }
